...
const routes: Routes = [
  ...
  // {path: 'forgot/mailto', component: ForgotMailtoComponent , canActivate: [NoneGuard]},
  // {path: 'forgot/password_change', component: ForgotChangePassComponent , canActivate: [NoneGuard]},
